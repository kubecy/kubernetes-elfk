...
>默认情况下，Elasticsearch 会根据节点[的角色](https://www.elastic.co/guide/en/elasticsearch/reference/7.13/modules-node.html#node-roles)和总内存自动设置 JVM 堆大小。对于大多数生产环境，建议使用默认大小调整。
>
